  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Fundraise widget SVG */}
        <div className="px-4 pt-2">
          <img
            src="/assets/fundraise widget 1.svg"
            alt="Fundraise Widget"
            style={{ width: '100%', borderRadius: '24px', display: 'block' }}
            draggable={false}
          />
        </div>

        {/* Eligible to withdraw checkmark and text */}
        <div className="flex flex-row items-center justify-center mt-4 gap-2 px-6">
          {/* Lucide circle-check SVG */}
          <svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7.62516 9.49992L9.2085 11.0833L12.3752 7.91658M17.9168 9.49992C17.9168 13.8722 14.3724 17.4166 10.0002 17.4166C5.62791 17.4166 2.0835 13.8722 2.0835 9.49992C2.0835 5.12766 5.62791 1.58325 10.0002 1.58325C14.3724 1.58325 17.9168 5.12766 17.9168 9.49992Z" stroke="#696F79" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          <span
            style={{
              color: '#696F79',
        ...
        {/* Past campaign widgets */}
        <div className="px-4 flex flex-col gap-4 pb-8">
          <img
            src="/assets/activity Widget 2.svg"
            alt="Past Campaign 2"
            style={{ width: '100%', borderRadius: '24px', display: 'block' }}
            draggable={false}
          />
          <img
            src="/assets/activity Widget 3.svg"
            alt="Past Campaign 3"
            style={{ width: '100%', borderRadius: '24px', display: 'block' }}
            draggable={false}
          />
          <img
            src="/assets/activity Widget 4.svg"
            alt="Past Campaign 4"
            style={{ width: '100%', borderRadius: '24px', display: 'block' }}
            draggable={false}
          />
          <img
            src="/assets/activity Widget 5.svg"
            alt="Past Campaign 5"
            style={{ width: '100%', borderRadius: '24px', display: 'block' }}
            draggable={false}
          />
        ...
        >
          ...
          >
            ...
            {/* Campaigns (Donation) icon - ACTIVE, with highlight */}
            <button
        ...
        {/* Floating glassmorphic create button (INSIDE phone container) */}
        <button
          style={{
            position: 'sticky',
            right: 24,

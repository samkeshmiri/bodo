    ...
    <div className="flex items-center justify-center min-h-screen w-full relative" style={{ minHeight: '100vh', background: '#000', overflow: 'hidden' }}>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center relative z-10 px-6 pt-40" style={{ flex: 1 }}>
          {/* Heading and subtext */}
          <h1 className="text-3xl font-bold text-white mb-2" style={{ fontFamily: 'Red Hat Display, sans-serif', letterSpacing: 0.5 }}>You're in!</h1>
          <p className="text-lg text-gray-200 mb-8 text-center" style={{ fontWeight: 400 }}>You've joined this fundraiser. Copy the code or share with friends to spread the word!</p>
